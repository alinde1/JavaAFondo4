...
DROP TABLE IF EXISTS promocion_vigencia;
...
INSERT INTO promocion_vigencia VALUES (10 ,1,now(), now() + '7 day');
INSERT INTO promocion_vigencia VALUES (11,1,now() + '-15 day', now() + '10 day');
INSERT INTO promocion_vigencia VALUES (12,1,now() + '-25 day', now() + '30 day');
INSERT INTO promocion_vigencia VALUES (20,2,now() + '-2 day', now() + '5 day');
INSERT INTO promocion_vigencia VALUES (21,2,now() + '-18 day', now() + '13 day');
INSERT INTO promocion_vigencia VALUES (30,3,now() + '-26 day', now() + '8 day');
INSERT INTO promocion_vigencia VALUES (31,3,now() + '-4 day', now() + '1 day');
INSERT INTO promocion_vigencia VALUES (32,3,now() + '-4 day', now() + '10 day');
...
CREATE TABLE tipo_cliente (
            id_tipo_cliente SERIAL PRIMARY KEY -- INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,descripcion VARCHAR(255));
INSERT INTO tipo_cliente VALUES (DEFAULT, 'Consumidor Final');
INSERT INTO tipo_cliente VALUES (DEFAULT, 'Revendedor');

CREATE TABLE cliente (    
            id_cliente SERIAL PRIMARY key  -- INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,nombre VARCHAR(255)
           ,direccion VARCHAR(255)
...
INSERT INTO cliente VALUES (default, 'Marcelo Gallardo','Pje. Los Robles 351',1);
INSERT INTO cliente VALUES (default, 'Ricardo Villar','Av. Jos� Mar�a Moreno 667',1);
INSERT INTO cliente VALUES (default, 'Mar�a Montana','Ram�n Falc�n 5123',1);
INSERT INTO cliente VALUES (default, 'Marcelo Rold�n','Donato �lvarez 145',1);
INSERT INTO cliente VALUES (default, 'Paula P�rez','Av. Del Libertador 7734',1);
INSERT INTO cliente VALUES (default, 'Electr�nica Matsushita','Av. Rivadavia 1241',2);
INSERT INTO cliente VALUES (default, 'Audio Confort','Av. Santa Fe 3411',2);
           
CREATE TABLE empleado (    
            id_empleado SERIAL PRIMARY KEY -- INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
           ,nombre VARCHAR(255)
           ,id_jefe INTEGER);
ALTER TABLE empleado ADD FOREIGN KEY (id_jefe) REFERENCES empleado (id_empleado);

INSERT INTO empleado VALUES (DEFAULT,'Jos� Vel�zquez',NULL);
INSERT INTO empleado VALUES (DEFAULT,'Pedro Galimberti',1);
INSERT INTO empleado VALUES (DEFAULT,'Carlos Mart�nez',1);
INSERT INTO empleado VALUES (DEFAULT,'Reynaldo Jauregui',1);
INSERT INTO empleado VALUES (DEFAULT,'Ram�n Sinay',4);
INSERT INTO empleado VALUES (DEFAULT,'Pedro Alfonso',4);
INSERT INTO empleado VALUES (DEFAULT,'Ricardo Garc�a',3);
INSERT INTO empleado VALUES (DEFAULT,'Maribel Flores',3);

CREATE TABLE orden (
    id_orden SERIAL PRIMARY KEY -- INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
   ,id_cliente INTEGER
   ,id_empleado INTEGER
   ,fecha_generada DATE
...
CREATE TABLE detalle_orden (
    id_detalle_orden SERIAL PRIMARY KEY -- INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) PRIMARY KEY
   ,id_orden INTEGER
   ,id_producto INTEGER
   ,cantidad INTEGER);
